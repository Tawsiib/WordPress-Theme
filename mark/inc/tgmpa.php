...
add_action( 'tgmpa_register', 'mark_register_required_plugins' );
 ...
 */
function mark_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'               => 'Mark-Companion', // The plugin name.
			'slug'               => 'mark-companion', // The plugin slug (typically the folder name).
			'source'             => get_template_directory() . '/plugins/mark-companion.zip', // The plugin source.
