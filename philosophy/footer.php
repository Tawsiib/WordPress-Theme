            ...
            <div class="block-1-2 block-m-full popular__posts">
                <article class="col-block popular__post">
                    <a href="#0" class="popular__thumb">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/thumbs/small/wheel-150.jpg"
                             alt="">
                    </a>
                ...
                <article class="col-block popular__post">
                    <a href="#0" class="popular__thumb">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/thumbs/small/shutterbug-150.jpg"
                             alt="">
                    </a>
                ...
                <article class="col-block popular__post">
                    <a href="#0" class="popular__thumb">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/thumbs/small/cookies-150.jpg"
                             alt="">
                    </a>
                ...
                <article class="col-block popular__post">
                    <a href="#0" class="popular__thumb">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/thumbs/small/beetle-150.jpg"
                             alt="">
                    </a>
                ...
                <article class="col-block popular__post">
                    <a href="#0" class="popular__thumb">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/thumbs/small/tulips-150.jpg"
                             alt="">
                    </a>
                ...
                <article class="col-block popular__post">
                    <a href="#0" class="popular__thumb">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/thumbs/small/salad-150.jpg"
                             alt="">
                    </a>
