<?php
	...
	class Social_Icons_Widget extends WP_Widget
	{
		...
		{
			if ( isset( $instance[ 'title' ] ) && isset( $instance[ 'classname' ] ) ) {
				$title     = $instance[ 'title' ];
				$classname = $instance[ 'classname' ];
			} else {
				$title     = __( 'Social Icons', 'philosophy' );
				$classname = __( ' ', 'philosophy' );
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'classname' ) ); ?>"><?php _e( 'Class name:', 'philosophy' ); ?></label>
