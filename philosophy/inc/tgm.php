...
function philosophy_register_required_plugins()
{
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'Philosophy Social Icons', // The plugin name.
            'slug'               => 'philosophy-social-icons', // The plugin slug (typically the folder name).
            'source'             => get_template_directory() . '/plugins/philosophy-social-icons.zip', // The plugin source.
